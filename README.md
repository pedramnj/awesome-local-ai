...
|---|---|
| Run a chat LLM on my laptop, today | [Ollama](https://ollama.com) or [LM Studio](https://lmstudio.ai) |
| Build a private chatbot with my own docs | [Open WebUI](https://github.com/open-webui/open-webui) + [Ollama](https://ollama.com) |
| Add an offline code assistant to my editor | [Continue](https://continue.dev) + [Tabby](https://github.com/TabbyML/tabby) |
| Generate images privately | [ComfyUI](https://github.com/comfyanonymous/ComfyUI) or [Fooocus](https://github.com/lllyasviel/Fooocus) |
| Run an LLM on my phone | [PocketPal](https://github.com/a-ghorbani/pocketpal-ai) or [MLC LLM](https://github.com/mlc-ai/mlc-llm) |
| Replace cloud transcription | [whisper.cpp](https://github.com/ggerganov/whisper.cpp) or [faster-whisper](https://github.com/SYSTRAN/faster-whisper) |
| Build offline voice assistants | [Piper](https://github.com/rhasspy/piper) (TTS) + [whisper.cpp](https://github.com/ggerganov/whisper.cpp) (STT) |
| Stand up a multi-user team server | [LibreChat](https://github.com/danny-avila/LibreChat) + [Ollama](https://ollama.com) |

Not sure what your hardware can run? Jump to the [Hardware Guide](#hardware-guide).
...
- [MLC Chat](https://github.com/mlc-ai/mlc-llm) — iOS + Android mobile inference via TVM compilation.
...
- [llama.cpp quantize](https://github.com/ggerganov/llama.cpp) — The reference path for GGUF quantization (Q2 → Q8).
...
- [Practical Deep Learning for Coders](https://course.fast.ai) — fast.ai. Still the best on-ramp for working engineers.
...
[CC0 1.0 Universal](LICENSE). To the extent possible under law, contributors have waived all copyright and related rights to this work.
